...
const HomePage = dynamic(() => import('@/components/pages/HomePage'), { ssr: false, loading: () => <div>Loading...</div> });
const CapsulesPage = dynamic(() => import('@/components/pages/CapsulesPage'), { ssr: false, loading: () => <div>Loading...</div> });
...
export default function VynceSocialUI() {
  const { currentPage, currentTheme, showThemeSelector, toggleSidebar, setSidebarOpen, toast, hideToast } = useAppStore();
