...
const houses = [
  { name: 'Design', icon: '🎨', members: '23.4K', online: 891, gradient: 'from-purple-500 to-pink-500', isJoined: true },
  { name: 'Tech', icon: '💻', members: '45.2K', online: 1400, gradient: 'from-blue-500 to-cyan-500', isJoined: true },
  { name: 'Creative', icon: '✨', members: '18.7K', online: 765, gradient: 'from-pink-500 to-rose-500', isJoined: false },
  { name: 'Gaming', icon: '🎮', members: '67.8K', online: 2300, gradient: 'from-green-500 to-emerald-500', isJoined: true },
  { name: 'Music', icon: '🎵', members: '34.1K', online: 1120, gradient: 'from-orange-500 to-yellow-500', isJoined: false },
  { name: 'Photography', icon: '📸', members: '29.3K', online: 987, gradient: 'from-indigo-500 to-purple-500', isJoined: true }
];
