          ...
          <div className="rounded-[26px] card-matte-dark p-6 shadow-[inset_0_0_8px_rgba(255,255,255,0.05)]">
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex items-center gap-4">
                ...
                ">
                  <div className="w-16 h-16 rounded-xl bg-[#131419] flex items-center justify-center
...
</div>  {/* END profile hero card inner matte */}
</div>  {/* END profile hero outer border */}
