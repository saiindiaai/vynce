  ...
  const [relatedFights] = useState([
    {
      id: 4,
      fighter1: "ProDev",
      fighter2: "CloudWizard",
      viewers: 892,
      status: "live",
      gradient1: "from-blue-500 to-purple-500",
      gradient2: "from-pink-500 to-red-500",
    },
    {
      id: 5,
      fighter1: "DesignPro",
      fighter2: "PixelMaster",
      viewers: 456,
      status: "live",
    ...
    },
    {
      ...
      gradient2: "from-orange-500 to-yellow-500",
    },
  ]);
    ...
    <div className="w-full h-full bg-slate-950 flex flex-col">
      ...
      <div className="sticky top-0 z-30 border-b border-slate-800 p-3 sm:p-4 flex items-center justify-between flex-shrink-0 bg-slate-950">
        <div className="flex items-center gap-2">
          ...
          <span className="text-slate-400 text-xs hidden sm:inline">
            {fight.viewers.toLocaleString()} watching
          </span>
      ...
      <div className="flex-1 flex flex-col sm:flex-row min-h-0 overflow-auto h-[calc(100vh-56px)] overscroll-contain">
            ...
            <div className="flex items-start justify-between gap-2 mb-3">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-slate-400">
                  🎥 Epic Battle • {fight.viewers.toLocaleString()} viewers
                </p>
              </div>
        ...
        <div className="hidden sm:flex sm:w-80 bg-slate-900 flex-col border-l border-slate-800 overflow-auto h-full">
          ...
          <div className="p-3 border-b border-slate-800 flex-shrink-0 text-xs text-slate-400">
            Voting is available via the flame button in the chat input.
          </div>

          {/* Live Comments */}
          <div className="flex-1 overflow-y-auto min-h-0 h-full">
            <div className="p-4 space-y-3">
              <h3 className="text-sm font-bold text-slate-50 sticky top-0 bg-slate-900 py-2">
                Live Chat
              </h3>
            ...
            <div className="relative">
              <div className="flex gap-2 items-end">
                ...
                <div className="relative">
                  ...
                  <div
                    className={`absolute right-0 bottom-full mb-2 w-44 p-2 bg-slate-800 rounded-lg shadow-lg ${showVotePanel ? "block" : "hidden"}`}
                  >
      ...
      <div className="sm:hidden flex-1 flex flex-col min-h-0 overflow-auto bg-slate-900 h-full">
        ...
        <div className="p-3 border-b border-slate-800 flex-shrink-0 text-xs text-slate-400">
          Use the flame button in the chat input to support a team.
        </div>

        {/* Mobile Live Comments */}
        <div className="flex-1 overflow-y-auto min-h-0">
          <div className="p-3 space-y-2">
            <h3 className="text-xs font-bold text-slate-50 sticky top-0 bg-slate-950 py-1">
              Live Chat
            </h3>
            {liveComments.map((comment) => (
          ...
          <div className="relative">
            <div className="flex gap-2 items-end">
              ...
              <div className="relative">
                ...
                <div
                  className={`absolute right-0 bottom-full mb-2 w-40 p-2 bg-slate-800 rounded-lg shadow-lg ${showVotePanel ? "block" : "hidden"}`}
                >
                  <div className="text-xs text-slate-300 mb-1">Support a team</div>
                  <div className="flex gap-2">
                    <button
