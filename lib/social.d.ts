...
export declare function createComment(postId: string | number, content: string, parentCommentId?: string): Promise<any>;

export declare function fetchCommentsByPost(postId: string | number): Promise<any[]>;

export declare function likeComment(commentId: string): Promise<any>;

export declare function dislikeComment(commentId: string): Promise<any>;
